...
urlpatterns = [
    ...
    path('campaign-details/<int:campaign_id>/', campaign_details,
        name='campaign-details'),
    path('canvas-details/<int:canvas_id>/', canvas_details,
     name='canvas-details'),
    path('canvasser-details/<int:canvasser_id>/', canvasser_details,
        name='canvasser-details'),
    path('canvas-area/<int:canvas_id>/', canvas_area_define,
        name='canvas-area'),
